...
.voice-summary {
  ...
  padding: 20px 22px;
  border-radius: 24px;
  background: radial-gradient(circle at top right, rgba(130, 164, 255, 0.22), transparent 32%),
    linear-gradient(135deg, #f8f9ff 0%, #eef3ff 48%, #fdf7ff 100%);
  border: 1px solid rgba(72, 93, 137, 0.08);
}
